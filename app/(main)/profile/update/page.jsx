      ...
      <div className="bg-white min-h-screen">
        <div className="bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 py-14">
          <div className="container mx-auto px-4 text-center">
            <div className="h-7 bg-zinc-700 rounded w-48 mx-auto animate-pulse" />
          </div>
        </div>
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="container mx-auto px-4 py-10">
        <div className="max-w-lg mx-auto">
          <Link
            href="/profile"
            className="inline-flex items-center gap-1.5 text-sm text-zinc-500 hover:text-orange-500 mb-6 transition-colors"
          >
              ...
              {fields.map((field) => (
                <div key={field.id}>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 border border-zinc-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-colors"
                  />
                </div>
              ))}
